...
local MANIFEST_URL = "https://raw.githubusercontent.com/hoykoS/Dex/main/data/manifest.json"
local PAYLOAD_URL = "https://raw.githubusercontent.com/hoykoS/Dex/main/data/payload.enc"
